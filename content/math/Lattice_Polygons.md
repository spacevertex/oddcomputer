...
![A quadrilateral lattice polygon demostrating through motion that the points can be moved and still satisfy the 4:1 constraint, so there are infinitely many](/images/LatticePolygons/Diamond_Flexible.gif)